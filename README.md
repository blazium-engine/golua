...
![Build Status](https://github.com/blazium-engine/golua/actions/workflows/build.yml/badge.svg)

Simplest way to install:

	# go get github.com/blazium-engine/golua/lua
...
$ go get -f -u -tags luajit github.com/blazium-engine/golua/lua
```
